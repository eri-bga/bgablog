"""
Django settings for bgablog project.
...
SECRET_KEY = 'django-insecure-4r9s1w+fx4s6h@60tz+w^0&jhklt@=e448cwo@_j9p^i0d7dzq'
...
WSGI_APPLICATION = 'bgablog.wsgi.application'
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 5242800 # 5mb
